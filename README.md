  ...
  **Data** · Pandas · NumPy · Power BI · Tableau
  ...
  Self-hosted server that connects AI assistants (Claude, Cursor) to your Microsoft 365
  data — calendar, emails, OneNote, OneDrive — with semantic search, persistent memory,
  and automatic meeting briefings.
  ...
  **Python Web Developer — AMF Safety Shoes** (2023–2025)
  Built 3+ internal web apps in Flask and FastAPI used daily by production and operations
  teams. REST APIs, SQL data modeling, KPI dashboards for leadership.

  **Data Analyst — INCRA-RJ** (2021–2023)
  ETL pipelines in Python and SQL, Power BI and Tableau dashboards for government
  regional reporting.
